...
Para complementar a coleta de dados, foram conduzidos testes de entrada e saída no software desenvolvido. 
...
será fundamental para avaliar a facilidade de uso do software e sua adaptação para diferentes usuários. 
...
A comunicação ocorre via JSON e são utilizados objetos DTO \footnote{
    Objetos DTO (Data Transfer Object) são classes simples que transferem dados entre subsistemas de um software. 
    São um padrão de projeto de software que encapsulam dados para que possam ser transferidos entre camadas de uma aplicação.
