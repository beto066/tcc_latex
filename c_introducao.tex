...
\begin{itemize}
    \item Realizar levantamento bibliográfico acerca do uso de metodologias ABA para aprendizado por reforço;
    \item Identificar e validar as funcionalidades mais relevantes para a implementação da metodologia ABA com base em entrevistas com terapeutas e usuários;
    \item Discutir a relevancia de softwares de fácil  usabilidade, para a aplicação do metodo ABA que proporcione acessibilidade a quem necessite.
    \item Elaborar uma proposta de layout da plataforma;
